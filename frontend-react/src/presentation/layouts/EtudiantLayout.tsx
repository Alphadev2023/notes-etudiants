...
const NAV_ITEMS = [
  ...
  { label: "Mes notes", to: "/etudiant/notes", icon: ClipboardList },
  { label: "Mes relevés", to: "/etudiant/releves", icon: FileText },
];

export function EtudiantLayout() {
    ...
    <div className="flex h-screen bg-neutral-50 overflow-hidden">
          ...
          {sidebarOpen && currentUser && (
            <div className="flex items-center gap-3 px-3 py-2 rounded-lg bg-neutral-50 mb-1">
              <div className="w-8 h-8 bg-warning-100 rounded-full flex items-center justify-center flex-shrink-0">
                <span className="text-warning-600 text-xs font-bold">
              ...
              <div className="overflow-hidden">
                ...
                <p className="text-xs text-neutral-400">Étudiant</p>
              </div>
            </div>
          )}
          <button
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="bg-white border-b border-neutral-200 px-6 py-4 flex items-center gap-4">
          ...
          <NotificationBell />
          <span className="px-2.5 py-0.5 rounded-full text-xs font-medium bg-warning-50 text-warning-700">
            Étudiant
          </span>
        </header>
